 ...
 */
@Slf4j
public class DefaultWenXinAuthInterceptor extends WenXinAuthInterceptor {
    /**
     * 请求头处理
     */
    public DefaultWenXinAuthInterceptor() {
     ...
     */
    public DefaultWenXinAuthInterceptor(Map warringConfig) {
